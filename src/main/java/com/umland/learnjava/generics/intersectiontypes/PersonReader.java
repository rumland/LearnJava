...
public class PersonReader {
     ...
     *   1) Specify a missing interface where you do _not_ have controll over the source. For example, a missing
     *      interface in the core java library. This type of example is shown in the read method.
     *   2) Enable compatibility. For example, if you look at Collections.max's signature:
     ...
     *      Comparable<? super T> then when T was erased you would have a type of Comparable. To enable backwards
